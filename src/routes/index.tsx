...
import { CARS, liveAuctions, formatNumber } from "@/lib/mock-data";
    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-7 animate-fade-up">
              <Badge variant="outline" className="glass gap-2 px-3 py-1.5 border-primary/30">
                ...
                <span className="text-xs">Live auction starting in 7 minutes</span>
              </Badge>
            ...
            <div className="relative animate-fade-up">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-border/60 shadow-elegant animate-float">
                <img src={heroCar} alt="Featured McLaren GT" width={1920} height={1280} className="w-full h-auto" />
                ...
                <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                  ...
                  <div className="glass-strong rounded-lg px-3 py-2 text-right">
                    ...
                    <div className="font-display font-bold tabular-nums">187</div>
                  </div>
                </div>
                <div className="absolute bottom-5 left-5 right-5 glass-strong rounded-xl p-4">
                  <div className="flex justify-between items-end">
                    <div>
                      <div className="text-xs text-muted-foreground">McLaren GT · 2022</div>
                      <div className="font-display text-xl font-bold">EGP 4,850,000</div>
                    </div>
                    <Button asChild size="sm" className="bg-gradient-primary border-0 text-primary-foreground">
                      <Link to="/cars/$carId" params={{ carId: "mclaren-gt-2022" }}>Bid Now</Link>
                    </Button>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {live.slice(0, 3).map((c) => <CarCard key={c.id} car={c} />)}
        </div>
      </section>
